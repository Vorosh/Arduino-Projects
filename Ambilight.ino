...
#define OFF_TIME 100000          // время (секунд), через которое лента выключится при пропадаании сигнала
...
#define BRIGHT_CONSTANT 750  // константа усиления от внешнего света (0 - 1023)
